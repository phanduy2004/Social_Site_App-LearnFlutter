...
abstract class MeetRepository{
  ...
  Future<Either<Failure, MeetEntity>> createMeets({required String title,required String description, required TimeOfDay time, required LatLng location, required List<JobTypeEntity> jobTypes});
